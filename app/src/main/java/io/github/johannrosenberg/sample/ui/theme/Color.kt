...
class AppColors {
    companion object {
        ...
        var drawerContent = if (useLightTheme) MaterialColors.gray900 else Color.White
        var drawerSelected = if (useLightTheme) darkTurquoise else turquoise
        var snackbarNormalBg = if (useLightTheme) Color(0xDC146CD6) else MaterialColors.blue700
        var snackbarNormalText = if (useLightTheme) Color.White else Color.White
        var snackbarCriticalBg = if (useLightTheme) Color(0xFFE41717) else Color(0xFFFF4B4B)
        var snackbarCriticalText = if (useLightTheme) Color.White else Color.White
        var snackbarNormalAction = if (useLightTheme) Color.White else Color.White
        var snackbarCriticalAction = if (useLightTheme) Color(0xFFFFCBCB) else Color.White
