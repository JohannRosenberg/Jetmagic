...
https://medium.com/@johannblake/this-article-is-currently-a-work-in-progress-and-should-be-completed-by-september-4-2021-7746ba42666c

Add the following dependency to your gradle file:

```
implementation 'dev.wirespec.jetmagic:jetmagic:1.0.3'
```
...
The viewmodel parameter is optional. If you provide a reference to a viewmodel class (not an instance), then the CRM will create the viewmodel and associate it with the composable that gets rendered.
